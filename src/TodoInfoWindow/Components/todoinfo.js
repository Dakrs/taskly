    ...
    <div class="card-body" style="padding: 15px; padding-bottom:10px;">
      ...
      <table class="table table-borderless" style="margin-bottom:0">
        <tbody>
          ...
          <tr v-if="verifyProperty(todo.urgency)">
            <td class="details text-left grey">Urgency</td>
            <td class="details text-right">{{ todo.urgency }}</td>
          </tr>
          <tr v-if="verifyProperty(todo.importance)">
            <td class="details text-left grey">Importance</td>
            <td class="details text-right">{{ todo.importance }}</td>
          </tr>
        </tbody>
      </table>
    </div>
